...
def config():
    ...
    parser.add_argument("--concept-file-path", required =True, help="Path to the concepts generated by GPT")
...
if __name__ == "__main__":
    ...
    if args.classes == "cifar10":
        #concept_file_path = '/data/gpfs/projects/punim2103/GPT_concepts/cifar10_filtered.txt'
        concept_file_path = args.concept_file_path
        all_concepts = load_concepts_from_file(concept_file_path)
